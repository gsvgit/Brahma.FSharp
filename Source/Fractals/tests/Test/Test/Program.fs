...
let test1 scaling size mx my cr ci = fr.Juliacpu scaling size mx my cr ci  
let test2 scaling size mx my cr ci = fr.Juliagpu scaling size mx my cr ci   
let test3 scaling size mx my = fr.Mandelbrotcpu scaling size mx my 
let test4 scaling size mx my = fr.Mandelbrotgpu scaling size mx my 
