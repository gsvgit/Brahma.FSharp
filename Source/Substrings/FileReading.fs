...
//
//        readingTimer.Start()
//        cpuMatches <- cpuMatches + Helpers.countMatches cpuResult maxTemplateLength countingBound matchBound templateLengths prefix
//        readingTimer.Lap("counting")
//        
//        gpuMatches <- gpuMatches + Helpers.countMatches (NaiveSearchGpu.findMatches length k localWorkSize templates templateLengths buffer templateArr) maxTemplateLength countingBound matchBound templateLengths prefix
//        gpuMatchesHashing <- gpuMatchesHashing + Helpers.countMatches (NaiveHashingSearchGpu.findMatches length  maxTemplateLength k localWorkSize templates templatesSum templateLengths buffer templateArr) maxTemplateLength countingBound matchBound templateLengths prefix
//
//    reader.Close()
//
