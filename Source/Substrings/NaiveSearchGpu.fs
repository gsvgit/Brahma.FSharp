...
let Main () =
    ...
    let matches = NaiveSearch.countMatches (findMatches length k localWorkSize templates templateLengths gpuArr templateArr) maxTemplateLength length length templateLengths prefix
    printfn "done."
